...
//     $sql = "SELECT subservice_id,number_people,Date FROM sa_number_of_people WHERE 1";

//     // Append conditions based on search parameters
//     if (!empty($searchName)) {
//         $sql .= " AND subservice_id LIKE '%$searchName%'";
//     }
//     if (!empty($searchDate)) {
...
//     }
//     if (!empty($monthInput)) {
//         $sql .= " AND DATE_FORMAT(Date, '%Y-%m') = :monthInput";
//     }
