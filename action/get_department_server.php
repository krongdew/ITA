...
// SQL query
// SQL query
$sql = "SELECT * FROM sa_department WHERE 1 $searchQuery ORDER BY $orderColumn $orderDirection LIMIT $start, $length";
...
$totalFiltered = $conn->query("SELECT COUNT(*) FROM sa_department WHERE 1 $searchQuery")->fetchColumn();
