    ...
    <ul id="subMenu" class="sub-menu">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($current_page == 'user.php') ? 'active' : ''; ?>" href="../pages/user.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-user-gear text-warning text-sm opacity-10"></i>
              
            </div>
            <span class="nav-link-text ms-1">จัดการผู้ใช้งานระบบ</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($current_page == 'system.php') ? 'active' : ''; ?>" href="../pages/system.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-gear text-info text-sm opacity-10"></i>
              
            </div>
            <span class="nav-link-text ms-1">ตั้งค่าระบบ</span>
          </a>
        </li>
