                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="example-text-input" class="form-control-label">admin Password*: </label>
                                                                            <input id="adminPassword" class="form-control" type="password" name="Password" placeholder="Password เดิม" required>
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        $('form').submit(function(e) {
                            ...
                            $.ajax({
                                url: '../action/check_password_admin.php',
                                type: 'post',
                                data: {
                                    id: id,
