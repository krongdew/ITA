                    ...
                    <div class="row">
                        ...
                        <button class="badge badge-sm bg-gradient-warning" style="border: 0px;" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='white'" id="button-service" onclick="toggleAddForm()">สร้างแบบประเมินความพึงพอใจ</button> -->
                                ...
                                <div class="card-body px-0 pt-0 pb-2">
                                    <div id="add-form">
                                        <form method="post" action="../action/edit_service_base.php">
                                            <div class="container-fluid py-4">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="card">
                                                            <div class="card-header pb-0">
                                                                <div class="d-flex align-items-center">
                                                                    <p class="mb-0">แก้ไขบริการ (Services) ของกองกิจการนักศึกษา</p>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" type="hidden" id="id" name="ID" value="<?php echo $service['ID']; ?>">
                                                                            <input class="form-control" type="text" name="service_name" placeholder="ชื่อบริการ" value="<?php echo $service['service_name']; ?>">
                                                                        </div>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                if (count($departments) > 0) {
                                                                                    echo '<select name="service_Access"  id="department_id"  class="form-select" required>';
                                                                                            ...
                                                                                            if (count($subservices) > 0) {
                                                                                                ...
                                                                                                foreach ($subservices as $subservice) {
                                                                                                    ...
                                                                                                    try {
                                                                                                        ...
                                                                                                        if (count($units) > 0) {
                                                                                                            echo '<select name="subservice_Access[]"  id="subservice_Access"  class="form-select" required>';
                                                                                                    ...
                                                                                                    echo "<td style='font-size: smaller;'>";
                                                                                                    echo "<select name='subservice_status[]' id='subservice_status' class='form-select' required>";
                                                                                                    ...
                                                                                                    echo "</select></td>";
                                                                                                    echo "<td><button type='button' class='delBtn' onclick='deleteSubservices(this)' style='font-size: small;'>ลบแถว</button></td>";
                                        ...
                                        <td>
                                          <select class="form-select">
                                            ...
                                            <option value="0">ปิด</option>
                                                                ...
                                                                <br>
                                                                <button type="submit" class="btn btn-primary btn-sm ms-auto">แก้ไขบริการ</button>
