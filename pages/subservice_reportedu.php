...
<head>
  ...
  <title>
    รายงานสถิติจำนวนผู้เข้าใช้บริการย่อย ประจำปีการศึกษา
  </title>
  <!--     Fonts and icons     -->
      ...
      <div class="col-12">
        ...
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6>รายงานสถิติจำนวนผู้เข้าใช้บริการย่อย ประจำปีการศึกษา</h6>
          </div>
          ...
          table = $('#myTable').DataTable({
            ...
            columns: [{
                ...
                render: function(data) {
                  ...
                  return departmentInfo ? departmentInfo.service_name : '';
              ...
              },
              {
                ...
                render: function(data, type, row) {
                  var total = 0;
                  for (var key in data) {
                    if (data.hasOwnProperty(key) && key !== 'subservice_id' && key !== 'service_id'  && key !== 'sub_ea') {
            ...
            buttons: [
              'copyHtml5',
              {
                ...
                title: function() {
                  ...
                  return "รายงานสถิติจำนวนผู้เข้าใช้บริการ ประจำปีการศึกษา " + yearAsNumber;
                },
            ...
            serverSide: true,
            ajax: {
              url: "../action/get_subreportedu.php",
              type: "POST",
              dataType: "json",
              data: {
              ...
              getDeaprtmentData(function(departmentData) {
                api.column(0, {
                  ...
                  if (lastServiceAccess !== serviceAccess) {
                    ...
                    var departmentName = departmentInfo ? departmentInfo.service_name : '';
