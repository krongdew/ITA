...
--
-- Host: db
-- Generation Time: Feb 19, 2024 at 06:28 AM
...
CREATE TABLE `sa_assessment` (
  ...
  `AssessmentName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `AssessmentURL` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `QrCodeImageName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `service_id` int DEFAULT NULL,
  `AssessmentStatus` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `sa_department` (
  ...
  `department_memo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(56, 2, 3, 10, '2024-03-20', '2024-02-09 07:53:57'),
(57, 2, 4, 10, '2024-03-20', '2024-02-09 07:53:57'),
(58, 2, 5, 10, '2024-03-20', '2024-02-09 07:53:57'),
(59, 2, 3, 10, '2024-08-01', '2024-02-09 07:54:07'),
(60, 2, 4, 10, '2024-08-01', '2024-02-09 07:54:07'),
(61, 2, 5, 10, '2024-08-01', '2024-02-09 07:54:07'),
(62, 2, 3, 10, '2024-10-09', '2024-02-09 07:54:18'),
(63, 2, 4, 10, '2024-10-09', '2024-02-09 07:54:18'),
(64, 2, 5, 52, '2024-10-09', '2024-02-09 07:54:18'),
(65, 2, 3, 11, '2024-09-09', '2024-02-09 07:54:28'),
(66, 2, 4, 11, '2024-09-09', '2024-02-09 07:54:28'),
(67, 2, 5, 11, '2024-09-09', '2024-02-09 07:54:28'),
(68, 19, 34, 10, '2023-09-14', '2024-02-09 08:00:37'),
(69, 19, 35, 10, '2023-09-14', '2024-02-09 08:00:37'),
(70, 19, 36, 10, '2023-09-14', '2024-02-09 08:00:37'),
(71, 19, 34, 10, '2024-12-09', '2024-02-09 08:00:49'),
(72, 19, 35, 10, '2024-12-09', '2024-02-09 08:00:49'),
(73, 19, 36, 10, '2024-12-09', '2024-02-09 08:00:49'),
(74, 2, 3, 10, '2025-01-09', '2024-02-09 08:03:50'),
(75, 2, 4, 10, '2025-01-09', '2024-02-09 08:03:50'),
(76, 2, 5, 10, '2025-01-09', '2024-02-09 08:03:50'),
(77, 11, 22, 100, '2025-10-21', '2024-02-12 04:37:23'),
(78, 11, 29, 50, '2025-10-21', '2024-02-12 04:37:23'),
(79, 2, 3, 1, '2024-02-13', '2024-02-13 08:05:45'),
(80, 2, 4, 2, '2024-02-13', '2024-02-13 08:05:45'),
(81, 2, 5, 3, '2024-02-13', '2024-02-13 08:05:45');
...
CREATE TABLE `sa_question` (
  ...
  `QuestionType` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sa_services` (
  ...
  `service_detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `service_status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `service_Access` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `sa_subservices` (
  `ID` int NOT NULL,
  `service_id` int DEFAULT NULL,
  `subservice_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `subservice_detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `subservice_status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `subservice_Access` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
...
CREATE TABLE `sa_unit` (
  ...
  `memo` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sa_users` (
  ...
  `position_c` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email_other` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tell` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `UserType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'user',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ;
...
(12, 'admin', '$2y$10$.HnBHc/9shsgn.iMXvYxuulhVtp6TR3PKuTTB1qXdYptvkuPKagu.', 'ครองขวัญ บัวยอม', 2, 5, 'นักวิชาการสารสนเทศ', '', 'krongkwan.bua@mahidol.ac.th', 'dewwiisunny14@gmail.com', '0875350828', '028494501', '../upload/admin.jpg', 'user', '2024-01-23 03:02:27', '2024-02-19 02:35:00'),
(13, 'admin_dew', '$2y$10$QIqtVsD4etYO3S2DkJpO/elE9S39OgOwdpesI3h0AMYT9KxPQeFLO', 'ครองขวัญ บัวยอม', 0, 13, 'นักวิชาการสารสนเทศ', 'admin', 'krongkwan.bua@mahidol.ac.th', 'dewwiisunny14@gmail.com', '0875350828', '028494501', '../upload/admin_dew.jpg', 'admin', '2024-01-25 02:32:46', '2024-02-15 02:28:28');
...
--
ALTER TABLE `sa_respondent`
  MODIFY `RespondentID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
